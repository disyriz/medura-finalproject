...
function Signup() {
  ...
  return (
   ...
   <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: "#c6c6c6" }}>
      ...
      <section className="vh-100" style={{ backgroundColor: "#879889" }}>
                ...
                <div className="card-body p-md-5">
                  <div className="row justify-content-center">
                    ...
                    <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                      <img src="https://static.vecteezy.com/system/resources/previews/015/155/132/original/woman-working-on-a-task-illustration-concept-business-cartoon-character-busy-and-multitasking-success-young-businesswoman-with-document-student-studying-and-check-education-list-vector.jpg"
